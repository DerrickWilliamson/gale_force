...
//  Emits an asynchronous stream of events from the UI to the bloc.  Holds event classes or enums
//  that represent user actions, system events, or any other type of action that can affect the 
